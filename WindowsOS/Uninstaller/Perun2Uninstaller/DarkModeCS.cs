...
namespace Perun2Uninstaller
{
    ...
    public class DarkModeCS
    {
        ...
        public DarkModeCS(Form _Form, bool _ColorizeIcons = true, bool _RoundedPanels = false)
        {
            ...
            IsDarkMode = true; //IsDarkModeCSEnabled && GetWindowsColorMode() <= 0 ? true : false;
        ...
        public void ThemeControl(Control control)
        {
            ...
            if (control is System.Windows.Forms.Label)
            {
                ...
                control.Paint += (object sender, PaintEventArgs e) =>
                {
                    ...
                    {
                        var radio = (sender as System.Windows.Forms.Label);
        ...
        public static System.Drawing.Image ChangeToColor(System.Drawing.Image bmp, Color c) => (System.Drawing.Image)ChangeToColor((Bitmap)bmp, c);
    ...
    public class MyRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderItemImage(ToolStripItemImageRenderEventArgs e)
        {
            if (e.Item.GetType().FullName == "System.Windows.Forms.MdiControlStrip+ControlBoxMenuItem")
            {
                ...
                System.Drawing.Image image = e.Image;
                Color _ClearColor = e.Item.Enabled ? MyColors.TextActive : MyColors.SurfaceDark;

                using (System.Drawing.Image adjustedImage = DarkModeCS.ChangeToColor(image, _ClearColor))
                {

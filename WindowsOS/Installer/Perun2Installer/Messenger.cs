...
using static Perun2Installer.KeyValue;
...
namespace Perun2Installer
{
    ...
    public static class Messenger
    {
            ...
            MessageBoxButtons buttons = MessageBoxButtons.OK, bool pIsDarkMode = true)
        {
            ...
            foreach (var _button in CmdButtons)
            {
                ...
                _button.Font = new Font("Segoe UI", 12);
                _button.Width = 124;
                _button.Height = 35;
                _button.Location = new Point(LastPos / 2 - (_button.Width / 2), (bottomPanel.Height - _button.Height) / 2 - 5);
            ...
            System.Windows.Forms.Label lblPrompt = new System.Windows.Forms.Label
            {
                ...
                Location = new Point(picBox.X + picBox.Width - 2, picBox.Y),
            ...
            lblPrompt.Font = new Font("Segoe UI", 12);
            lblPrompt.BackColor = Color.FromArgb(30, 30, 30);
            ...
            MsgIcon Icon = 0, MessageBoxButtons buttons = MessageBoxButtons.OK, bool pIsDarkMode = true)
        {
            ...
            foreach (KeyValue field in Fields)
            {
                ...
                System.Windows.Forms.Label field_label = new System.Windows.Forms.Label
                {
                    Text = field.Key,
                    AutoSize = false,
                    Dock = DockStyle.Fill,
    ...
    public class Base64Icons
    {
        ...
        public System.Drawing.Image GetIcon(string pName)
        {
            System.Drawing.Image _ret = null;
        ...
        public System.Drawing.Image GetIcon(MsgIcon pIcon) => GetIcon(pIcon.ToString());
        ...
        /// <returns>'true' if success. No Size restrictions for the image.</returns>
